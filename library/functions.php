...
// /event_management/views/?v=LIST
function getBookingRecords(){
	$per_page = 10;
	$page = (isset($_GET['page']) && $_GET['page'] != '') ? $_GET['page'] : 1;
	$start 	= ($page-1)*$per_page;
	$sql 	= "SELECT u.id AS uid, u.name, u.namethai, u.phone, u.email,
			   r.ucount, r.rdate, r.status, r.comments,r.details,r.upload_file   
