<div class="col-md-8">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <span id="sprytf_name">
            ...
            <span class="textfieldMinCharsMsg">Name must specify at least 2 characters.</span>
          </span>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">ชิ่อฝ่าย</label>
          <span id="sprytf_namethai">
            <input type="text" name="namethai" class="form-control input-sm" placeholder="Namethai">
            <span class="textfieldRequiredMsg">Namethai is required.</span>
            <span class="textfieldMinCharsMsg">Namethai must specify at least 2 characters.</span>
          </span>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <span id="sprytf_type">
            <select name="type" class="form-control input-sm">
              ...
              <option value="student">ผู้ใช้งานทั่วไป</option>
              <option value="teacher">ผู้จัดการ/กลุ่มฝ่ายที่ลงข้อมูล/ผู้บริหาร</option>
  ...
  <script type="text/javascript">
    ...
    var sprytf_namethai = new Spry.Widget.ValidationTextField("sprytf_namethai", 'none', {
      minChars: 2,
      validateOn: ["blur", "change"]
    });
