        ...
        <tr>
          ...
          <?php if ($utype == 'on') { ?>
            <td><?php if ($status == "active") { ?>
                <a href="javascript:status('<?php echo $user_id ?>', 'inactive');" class="btn btn-info">Inactive</a>&nbsp;/
                &nbsp;<a href="javascript:status('<?php echo $user_id ?>', 'lock');" class="btn btn-warning">Account Lock</a>&nbsp;/
                &nbsp;<a href="javascript:status('<?php echo $user_id ?>', 'delete');" class="btn btn-danger">Delete</a>
              <?php } else { ?>
                <a href="javascript:status('<?php echo $user_id ?>', 'active');" lass="btn btn-success">Active</a>
              <?php } //else 
              ?>
            </td>
          <?php } ?>
