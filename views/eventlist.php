          ...
          <tr>
            ...
            <?php if ($utype == 'on') { ?>
              <td><?php if ($status == "PENDING") { ?>
                  <a href="javascript:approve('<?php echo $user_id ?>');" class="btn btn-success">Approve</a>&nbsp;/
                  &nbsp;<a href="javascript:decline('<?php echo $user_id ?>');" class="btn btn-warning">Denied</a>&nbsp;/
                  &nbsp;<a href="javascript:deleteUser('<?php echo $user_id ?>');" class="btn btn-danger">Delete</a>
                <?php } else { ?>
                  <a href="javascript:deleteUser('<?php echo $user_id ?>');" class="btn btn-danger">Delete</a>
                <?php } //else 
                ?>
              ...
              <td><a href="<?php echo WEB_ROOT; ?><?php echo $upload_file; ?>">
                  <target="_blank" class="btn btn-info btn-sm"> เปิดดู
                </a></td>
